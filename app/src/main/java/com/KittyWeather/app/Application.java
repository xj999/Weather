...
import com.KittyWeather.bean.Pm2d5;
import com.KittyWeather.bean.SimpleWeatherinfo;
...
public class Application extends android.app.Application {
	...
	private void initData() {
		mApplication = this; // 获取此窗口实例
		initCityList(); // 获取数据库城市数据
		mLocationClient = new LocationClient(this, getLocationClientOption());
		initWeatherIconMap(); // 初始化每个天气图标
		initWidgetWeather(); // 初始化每个天气插件图标
	...
	private CityDB openCityDB() {
		String path = "/data" + Environment.getDataDirectory().getAbsolutePath() + File.separator + "com.way.weather" + File.separator + CityDB.CITY_DB_NAME;
